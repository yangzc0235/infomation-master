...
public class HttpMethod {
    ...
    private final ApiService service3;
    Retrofit retrofit1;
    Retrofit retrofit2;
    Retrofit retrofit3;
    ...
    private HttpMethod() {
        ...
        retrofit3 = RetrofitBuilder.getRetrofit(Constant.BASE_URL_3);
    ...
    public Observable<LoginEntity> requestLogin(String name,String pwd){
        return service3.getLogin(name, pwd);
    }
